...
planner to guarantee task completeness. The goal is to create a unified
framework where the agent, during the course of its execution,
...
transition to guarantee that the robot completes the task while reducing
